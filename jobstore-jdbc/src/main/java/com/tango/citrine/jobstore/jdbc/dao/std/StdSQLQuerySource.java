...
public class StdSQLQuerySource extends AbstractQuerySource {
    ...
    private static final String SELECT_TRIGGERED_TEMPLATE = "SELECT * FROM %s WHERE next_execution_time <= :reference_time AND job_state = 'WAITING' ORDER BY next_execution_time ASC, priority DESC LIMIT :limit FOR UPDATE";
